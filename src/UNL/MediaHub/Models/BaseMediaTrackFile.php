<?php
abstract class UNL_MediaHub_Models_BaseMediaTrackFile extends Doctrine_Record
{
    ...
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('media_tracks_id', 'integer',   4,    array('unsigned' => 0, 'primary' => false, 'notnull' => true));
    ...
    {
        $this->hasOne('UNL_MediaHub_MediaTrack',
            array(
                'local'   => 'media_tracks_id',
                'foreign' => 'id'
            )
        );
        parent::setUp();
