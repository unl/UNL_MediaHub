 ...
 * @author bbieber
 */
abstract class UNL_MediaHub_NativeSqlList implements Countable
{
    ...
    abstract function setOrderBy(Doctrine_RawSql &$query);
    
    abstract protected function setComponent(Doctrine_RawSql &$query);
