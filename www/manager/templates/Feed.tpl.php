...
<p class="action"><a class="feed_details" href="<?php echo UNL_MediaYak_Manager::getURL(); ?>?view=feedmetadata&amp;id=<?php echo $context->id; ?>">Edit Feed Details</a></p>
<p class="action"><a class="feed_users" href="<?php echo UNL_MediaYak_Manager::getURL(); ?>?view=permissions&amp;feed_id=<?php echo $context->id; ?>">Edit Feed Users</a></p>