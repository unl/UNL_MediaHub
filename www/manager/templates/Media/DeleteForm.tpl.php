<form action="?view=feed&amp;id=<?php echo $parent->parent->context->options['id']; ?>" method="post" id="deletemedia_<?php echo $context->id; ?>" style="width:120px;">
    ...
    <a href="#" class="action delete" onclick="if (confirm('Are you sure? This will delete this media, and remove it from any associated channels.')) document.getElementById('deletemedia_<?php echo $context->id; ?>').submit();">Delete</a>
</form>