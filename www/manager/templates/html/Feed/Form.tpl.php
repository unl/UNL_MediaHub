                    ...
                    <fieldset id="feed_header">
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <input class="dcf-input-text" id="image_title" name="image_title" type="text" aria-describedby="image-title-details" value="<?php echo (isset($context->feed))? htmlentities($context->feed->image_title, ENT_QUOTES):''; ?>" />
                            </li>
                            <li>
