...
<fieldset id="media_header">
    ...
    <ol>
        ...
        <li>
            <label for="media_submit" class="element">&nbsp;</label><div class="element"><input id="media_submit" name="submit" value="Save" class="wdn-button wdn-button-brand" type="submit" /></div>
        </li>
