                    ...
                    <?php if ($user->canTranscodePro()): ?>
                        <div>
                            <fieldset>
                                ...
                                <p class="dcf-txt-sm">
                                    Only videos will be optimized. If you are
                                ...
                                <div>
                                    <div class="dcf-input-radio">
                                        ...
                                        <label for="optimization-1">
                                            None (video is already optimized with HandBrake presets)
                                        </label>
                                    </div>
                                    <div class="dcf-input-radio">
                    ...
                    <?php elseif ($user->canTranscode()): ?>
                        <div>
                            <fieldset>
                                <legend class="dcf-legend">Optimization Settings</legend>
                                <p class="dcf-txt-sm">
                                    Only videos will be optimized. If you are uploading an audio file,
