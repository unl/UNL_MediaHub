...
<div class="three_col left">
    <div id="preview"></div>
    <script type="text/javascript">UNL_MediaYak.writePlayer('<?php echo addslashes($this->title); ?>','<?php echo $this->url; ?>','preview', <?php echo $width; ?>, <?php echo $height; ?>);</script>
    <div id="comments">
        ...
        echo htmlentities(
            '<object height="'.($dimensions['height']+48).'" width="'.$dimensions['width'].'">'.
                ...
                '<embed src="http://www.unl.edu/ucomm/templatedependents/templatesharedcode/scripts/components/mediaplayer/player.swf?file='.$this->url.'&amp;'.
                             ...
                             'volume=100&amp;'.
                             'autostart=false&amp;'.
                             'skin=http://www.unl.edu/ucomm/templatedependents/templatesharedcode/scripts/components/mediaplayer/UNLVideoSkin.swf" type="application/x-shockwave-flash" allowscriptaccess="always" wmode="transparent" allowfullscreen="true" height="'.($dimensions['height']+48).'" width="'.$dimensions['width'].'"></embed>'.
            '</object>');
    ?></textarea>
