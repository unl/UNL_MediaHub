...
if ($theme->getName() == 'UNL') {
    ...
    $page->addScript('https://polyfill.io/v3/polyfill.min.js?flags=gated&features=default');
    $page->addScript('https://unlcms.unl.edu/wdn/templates_5.0/js/compressed/all.js?dep=5.0.14');
