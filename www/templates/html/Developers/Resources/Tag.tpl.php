    <div class="resource">
        ...
        <ul>
            <li>
                ...
                <blockquote>
                    <p><?php echo UNL_MediaHub_Controller::$url; ?>tags/{query}</p>
                </blockquote>
            </li>
            <li>
                    ...
                    <div id="tagsTab1">
                        <ul>
                            ...
                            <li>
                                ...
                                <?php 
                                //Get the output.
                                if (!$result = file_get_contents(UNL_MediaHub_Controller::$url."tags/idk?format=json")) {
                    ...
                    <div id="tagsTab2">
                        <ul>
                            ...
                            <li>
                                ...
                                <?php 
                                //Get the output.
                                if (!$result = file_get_contents(UNL_MediaHub_Controller::$url."tags/idk?format=xml")) {
                                    $result = "Error getting file contents.";
                                }
                                ?>
                                <pre class="code">
                    ...
                    <div id="tagsTab3">
                        <ul>
                            ...
                            <li>
                                ...
                                <?php 
                                //Get the output.
                                if (!$partial = file_get_contents(UNL_MediaHub_Controller::$url."tags/idk?format=partial")) {
