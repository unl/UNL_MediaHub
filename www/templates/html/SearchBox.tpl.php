...
<form method="get" action="<?php echo $baseUrl ?>search/" class="dcf-form mh-app-search">
    ...
    <div class="dcf-input-group">
        ...
        <button class="dcf-btn dcf-btn-primary" type="submit"><span aria-hidden="true"><?php echo \UNL\Templates\Icons::get(\UNL\Templates\Icons::ICON_SEARCH, '{"size": 6}'); ?></span><span class="dcf-sr-only">Search</span></button>
    </div>
</form>
